...
define(['dart_sdk', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__painting__debug_dart(dart_sdk, packages__flutter__src__foundation__debug$46dart) {
  ...
  var T = {
    ...
    SizeToint: () => (T.SizeToint = dart.constFn(dart_rti.findType("core|int(ui|Size)")))(),
    VoidToMapOfString$ObjectN: () => (T.VoidToMapOfString$ObjectN = dart.constFn(dart_rti.findType("core|Map<core|String,core|Object?>()")))(),
    ...
    PictureTobool: () => (T.PictureTobool = dart.constFn(dart_rti.findType("core|bool(ui|Picture)")))(),
    ImageTobool: () => (T.ImageTobool = dart.constFn(dart_rti.findType("core|bool(ui|Image)")))()
  };
  var G = {
  ...
  var I = [
    ...
    "dart:core",
    "dart:ui",
    "file:///Users/haggaibarel/DEV/flutter/packages/flutter/lib/src/painting/debug.dart"
  ];
  ...
  debug.ImageSizeInfo = class ImageSizeInfo extends core.Object {
    ...
    toJson() {
      return new (G.IdentityMapOfString$ObjectN()).from(["source", this.source, "displaySize", new (G.IdentityMapOfString$ObjectN()).from(["width", this.displaySize.width, "height", this.displaySize.height]), "imageSize", new (G.IdentityMapOfString$ObjectN()).from(["width", this.imageSize.width, "height", this.imageSize.height]), "displaySizeInBytes", this.displaySizeInBytes, "decodedSizeInBytes", this.decodedSizeInBytes]);
    }
    _equals(other) {
  ...
  dart.setMethodSignature(debug.ImageSizeInfo, () => dart.global.Object.setPrototypeOf({
    [_sizeToBytes]: T.SizeToint(),
    toJson: T.VoidToMapOfString$ObjectN()
  ...
  dart.setGetterSignature(debug.ImageSizeInfo, () => dart.global.Object.setPrototypeOf({
    displaySizeInBytes: T.int(),
    decodedSizeInBytes: T.int()
  ...
  dart.setFieldSignature(debug.ImageSizeInfo, () => dart.global.Object.setPrototypeOf({
    source: {type: T.StringN(), isConst: false, isFinal: true, libraryUri: I[1]},
    displaySize: {type: T.Size(), isConst: false, isFinal: true, libraryUri: I[2]},
    imageSize: {type: T.Size(), isConst: false, isFinal: true, libraryUri: I[2]}
