...
define(['dart_sdk', 'packages/material_color_utilities/utils/color_utils.dart', 'packages/material_color_utilities/utils/math_utils.dart'], (function load__packages__material_color_utilities__hct__viewing_conditions_dart(dart_sdk, packages__material_color_utilities__utils__color_utils$46dart, packages__material_color_utilities__utils__math_utils$46dart) {
  ...
  var T = {
    ...
    __ToViewingConditions: () => (T.__ToViewingConditions = dart.constFn(dart_rti.findType("material_color_utilities__hct__viewing_conditions|ViewingConditions({adaptingLuminance:core|double,backgroundLstar:core|double,discountingIlluminant:core|bool,surround:core|double,whitePoint:core|List<core|double>?})")))(),
    ViewingConditions: () => (T.ViewingConditions = dart.constFn(dart_rti.findType("material_color_utilities__hct__viewing_conditions|ViewingConditions")))(),
  ...
  var I = [
    "file:///Users/haggaibarel/.pub-cache/hosted/pub.dev/material_color_utilities-0.8.0/lib/hct/viewing_conditions.dart",
  ...
  viewing_conditions.ViewingConditions = class ViewingConditions extends core.Object {
    ...
    static make(opts) {
      ...
      backgroundLstar = math.max(T.double(), 0.1, backgroundLstar);
      let xyz = whitePoint;
      ...
      let nc = f;
      let rgbD = G.JSArrayOfdouble().of([d * (100.0 / rW) + 1.0 - d, d * (100.0 / gW) + 1.0 - d, d * (100.0 / bW) + 1.0 - d]);
      ...
      let ncb = nbb;
      let rgbAFactors = G.JSArrayOfnum().of([math.pow(fl * rgbD[$_get](0) * rW / 100.0, 0.42), math.pow(fl * rgbD[$_get](1) * gW / 100.0, 0.42), math.pow(fl * rgbD[$_get](2) * bW / 100.0, 0.42)]);
      let rgbA = G.JSArrayOfdouble().of([400.0 * rgbAFactors[$_get](0) / (rgbAFactors[$_get](0) + 27.13), 400.0 * rgbAFactors[$_get](1) / (rgbAFactors[$_get](1) + 27.13), 400.0 * rgbAFactors[$_get](2) / (rgbAFactors[$_get](2) + 27.13)]);
      let aw = (40.0 * rgbA[$_get](0) + 20.0 * rgbA[$_get](1) + rgbA[$_get](2)) / 20.0 * nbb;
      return new viewing_conditions.ViewingConditions.new({whitePoint: whitePoint, adaptingLuminance: adaptingLuminance, backgroundLstar: backgroundLstar, surround: surround, discountingIlluminant: discountingIlluminant, backgroundYTowhitePointY: n, aw: aw, nbb: nbb, ncb: ncb, c: c, nC: nc, drgbInverse: G.JSArrayOfdouble().of([0.0, 0.0, 0.0]), rgbD: rgbD, fl: fl, fLRoot: math.pow(fl, 0.25)[$toDouble](), z: z});
    }
  ...
  dart.setFieldSignature(viewing_conditions.ViewingConditions, () => dart.global.Object.setPrototypeOf({
    whitePoint: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[2]},
    adaptingLuminance: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    backgroundLstar: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    surround: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    discountingIlluminant: {type: T.bool(), isConst: false, isFinal: true, libraryUri: I[2]},
    backgroundYTowhitePointY: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    aw: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    nbb: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    ncb: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    c: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    nC: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    drgbInverse: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[2]},
    rgbD: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[2]},
    fl: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    fLRoot: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]},
    z: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[2]}
