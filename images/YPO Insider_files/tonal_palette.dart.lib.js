...
define(['dart_sdk', 'packages/material_color_utilities/hct/hct.dart', 'packages/collection/src/equality.dart'], (function load__packages__material_color_utilities__palettes__tonal_palette_dart(dart_sdk, packages__material_color_utilities__hct__hct$46dart, packages__collection__src__equality$46dart) {
  ...
  var C = [void 0];
  var I = [
    "file:///Users/haggaibarel/.pub-cache/hosted/pub.dev/material_color_utilities-0.8.0/lib/palettes/tonal_palette.dart",
  ...
  var _keyColor = dart.privateName(tonal_palette, "_keyColor");
  var _is = dart.privateName(dart_rti, "_is");
  tonal_palette.TonalPalette = class TonalPalette extends core.Object {
    get keyColor() {
      let t$360;
      t$360 = this[_keyColor];
      return t$360 == null ? hct.Hct.from(0.0, 0.0, 0.0) : t$360;
    }
    get hue() {
      let t$360;
      t$360 = this[_hue];
    ...
    static fromList(colors) {
      if (!(colors[$length] === tonal_palette.TonalPalette.commonSize)) dart.assertFailed(null, I[0], 89, 12, "colors.length == commonSize");
    ...
    get(tone) {
      if (this[_hue] == null || this[_chroma] == null) {
        if (!this[_cache][$containsKey](tone)) {
          dart.throw(new core.ArgumentError.value(tone, "tone", "When a TonalPalette is created with fromList, tone must be one of " + dart.strSafe(tonal_palette.TonalPalette.commonTones)));
        } else {
          return dart.nullCheck(this[_cache][$_get](tone));
        }
      }
      let chroma = tone >= 90.0 ? math.min(T.double(), dart.nullCheck(this[_chroma]), 40.0) : dart.nullCheck(this[_chroma]);
  ...
  (tonal_palette.TonalPalette._fromHueAndChroma = function(hue, chroma) {
    ...
    this[_hue] = hue;
    this[_chroma] = chroma;
    this[_keyColor] = tonal_palette.TonalPalette.createKeyColor(hue, chroma);
    ;
  }).prototype = tonal_palette.TonalPalette.prototype;
  ...
  dart.setFieldSignature(tonal_palette.TonalPalette, () => dart.global.Object.setPrototypeOf({
    [_keyColor]: {type: T.HctN(), isConst: false, isFinal: true, libraryUri: I[3]},
    [_hue]: {type: T.doubleN(), isConst: false, isFinal: true, libraryUri: I[2]},
    [_chroma]: {type: T.doubleN(), isConst: false, isFinal: true, libraryUri: I[2]},
  ...
  }, '{"version":3,"sourceRoot":"","sources":["tonal_palette.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAiDsB;6BAAiB,aAAK,KAAK,KAAK;IAAI;;;AAEtC;6BAAQ;IAAG;;;AAER;6BAAW;IAAG;;;;;;;;;;cAsBL,KAAY;AACxC,YAAoB,kDAAkB,GAAG,EAAE,MAAM;IACnD;mBAGgC;AAC9B,YAAoB,yCAAS,GAAG;IAClC;oBAKuC;AACrC,YAAO,AAAO,AAAO,MAAR,cAAW;AACpB,kBAAkB;AACF,MAApB,AAAY,2DACR,SAAK,OAAW;;AAAc,qBAAK;gBAAC,SAAS;gBAAI,AAAM,MAAA,QAAC,KAAK;QAA1B;;;AACvC,YAAoB,2CAAW,KAAK;IACtC;0BAKiC,KAAY;AACpC,sBAAY;AACf,6BAAuB,aAAK,GAAG,EAAE,MAAM,EAAE,SAAS;AAC/C,0BAAmD,CAAlC,AAAiB,AAAO,gBAAR,UAAU,MAAM;AAOxD,eAAY,QAAQ,KAAK,AAAM,KAAD,GAAG,MAAM,QAAA,AAAM,KAAD,GAAI;AAK9C,YAAI,AAAO,AAAQ,