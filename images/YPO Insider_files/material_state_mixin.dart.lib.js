...
define(['dart_sdk', 'packages/flutter/src/material/material_state.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/widgets/unique_widget.dart'], (function load__packages__flutter__src__material__material_state_mixin_dart(dart_sdk, packages__flutter__src__material__material_state$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__widgets__unique_widget$46dart) {
  ...
  var T$ = {
    ...
    MaterialState__ToFn: () => (T$.MaterialState__ToFn = dart.constFn(dart_rti.findType("~(core|bool)(flutter__src__material__material_state|MaterialState{onChanged:~(core|bool)?})")))(),
    ...
    MaterialStateTovoid: () => (T$.MaterialStateTovoid = dart.constFn(dart_rti.findType("~(flutter__src__material__material_state|MaterialState)")))(),
  ...
  var G = {
    ...
    DiagnosticsPropertyOfSetOfMaterialState: () => (G.DiagnosticsPropertyOfSetOfMaterialState = dart.constFn(diagnostics.DiagnosticsProperty$(T$.SetOfMaterialState())))()
  };
  ...
  material_state_mixin.MaterialStateMixin$ = dart.generic(T => {
    ...
    MaterialStateMixin[dart.mixinOn] = State => class MaterialStateMixin extends State {
      ...
      debugFillProperties(properties) {
        ...
        properties.add(new (G.DiagnosticsPropertyOfSetOfMaterialState()).new("materialStates", this.materialStates, {defaultValue: G.LinkedHashSetOfMaterialState().new()}));
      }
    };
    (MaterialStateMixin[dart.mixinNew] = function() {
      this[materialStates] = G.LinkedHashSetOfMaterialState().new();
    ...
    dart.setMethodSignature(MaterialStateMixin, () => dart.global.Object.setPrototypeOf({
      updateMaterialState: T$.MaterialState__ToFn(),
      setMaterialState: T$.MaterialStateAndboolTovoid(),
      addMaterialState: T$.MaterialStateTovoid(),
      removeMaterialState: T$.MaterialStateTovoid()
    ...
    dart.setFieldSignature(MaterialStateMixin, () => dart.global.Object.setPrototypeOf({materialStates: {type: T$.SetOfMaterialState(), isConst: false, isFinal: false, libraryUri: I[1]}}, dart.getFields(dart.global.Object.getPrototypeOf(MaterialStateMixin))));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_state_mixin.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA8DqB;;;;;;0BA8CkC;YAA0B;AAC7E,cAAO,SAAM;;AACX,cAAI,AAAe,AAAc,6BAAL,GAAG,MAAK,KAAK;AACvC;;AAEF,gCAAiB,GAAG,EAAE,KAAK;AAC3B,2BAAS;0BAAT,OAAW,MAAK,KAAK;;MAEzB;uBAIoC,OAAY;AAC9C,cAAO,MAAK,GAAG,sBAAiB,KAAK,IAAI,yBAAoB,KAAK,CAAtD;MACd;uBAIoC;AAClC,YAAI,AAAe,wBAAI,KAAK;AAC1B,wBAAS;;;MAEb;0BAIuC;AACrC,YAAI,AAAe,2BAAO,KAAK;AAC7B,wBAAS;;;MAEb;;AAGuB,cAAA,AAAe,8BAAuB;MAAS;;AAGhD,cAAA,AAAe,8BAAuB;MAAQ;;AAG9C,cAAA,AAAe,8BAAuB;MAAM;;AAG5C,cAAA,AAAe,8BAAuB;MAAQ;;AAG9C,cAAA,AAAe,8BAAuB;MAAQ;;AAG9C,cAAA,AAAe,8BAAuB;MAAQ;;AAGxC,cAAA,AAAe,8BAAuB;MAAc;;AAGzD,cAAA,AAAe,8BAAuB;MAAS;0BAGjB;AAC7C,kCAAoB,UAAU;AACzB,QAAX,UAAU,KAAK,sDAAwC,kBAAkB,oCAA6C;MACxH;;;MA1GmB,uBAAgC","file":"../../../../../../../../../packages/flutter/src/material/material_state_mixin.dart.lib.js"}');
  // Exports:
  return {
