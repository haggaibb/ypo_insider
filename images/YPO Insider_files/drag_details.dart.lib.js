...
define(['dart_sdk', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/gestures/velocity_tracker.dart'], (function load__packages__flutter__src__gestures__drag_details_dart(dart_sdk, packages__flutter__src__foundation__object$46dart, packages__flutter__src__gestures__velocity_tracker$46dart) {
  ...
  var I = [
    ...
    "dart:ui",
    "dart:core",
    "file:///Users/haggaibarel/DEV/flutter/packages/flutter/lib/src/gestures/drag_details.dart",
  ...
  dart.addRtiResources(drag_details.DragDownDetails, ["flutter__src__gestures__drag_details|DragDownDetails"]);
  ...
  dart.addRtiResources(drag_details.DragStartDetails, ["flutter__src__gestures__drag_details|DragStartDetails"]);
  ...
  dart.setFieldSignature(drag_details.DragStartDetails, () => dart.global.Object.setPrototypeOf({
    sourceTimeStamp: {type: T.DurationN(), isConst: false, isFinal: true, libraryUri: I[2]},
    globalPosition: {type: T.Offset(), isConst: false, isFinal: true, libraryUri: I[1]},
    localPosition: {type: T.Offset(), isConst: false, isFinal: true, libraryUri: I[1]},
  ...
  (drag_details.DragUpdateDetails.new = function(opts) {
    ...
    if (!(primaryDelta == null || primaryDelta === delta.dx && delta.dy === 0.0 || primaryDelta === delta.dy && delta.dx === 0.0)) dart.assertFailed(null, I[3], 136, 10, "primaryDelta == null\n           || (primaryDelta == delta.dx && delta.dy == 0.0)\n           || (primaryDelta == delta.dy && delta.dx == 0.0)");
  ...
  dart.addRtiResources(drag_details.DragUpdateDetails, ["flutter__src__gestures__drag_details|DragUpdateDetails"]);
  ...
  dart.setFieldSignature(drag_details.DragUpdateDetails, () => dart.global.Object.setPrototypeOf({
    sourceTimeStamp: {type: T.DurationN(), isConst: false, isFinal: true, libraryUri: I[2]},
    delta: {type: T.Offset(), isConst: false, isFinal: true, libraryUri: I[1]},
    primaryDelta: {type: T.doubleN(), isConst: false, isFinal: true, libraryUri: I[2]},
    globalPosition: {type: T.Offset(), isConst: false, isFinal: true, libraryUri: I[1]},
    localPosition: {type: T.Offset(), isConst: false, isFinal: true, libraryUri: I[1]}
  ...
  (drag_details.DragEndDetails.new = function(opts) {
    ...
    if (!(primaryVelocity == null || primaryVelocity === velocity.pixelsPerSecond.dx && velocity.pixelsPerSecond.dy === 0 || primaryVelocity === velocity.pixelsPerSecond.dy && velocity.pixelsPerSecond.dx === 0)) dart.assertFailed(null, I[3], 218, 10, "primaryVelocity == null\n           || (primaryVelocity == velocity.pixelsPerSecond.dx && velocity.pixelsPerSecond.dy == 0)\n           || (primaryVelocity == velocity.pixelsPerSecond.dy && velocity.pixelsPerSecond.dx == 0)");
    ;
  }).prototype = drag_details.DragEndDetails.prototype;
  dart.addTypeTests(drag_details.DragEndDetails);
  dart.addRtiResources(drag_details.DragEndDetails, ["flutter__src__gestures__drag_details|DragEndDetails"]);
  ...
  dart.setFieldSignature(drag_details.DragEndDetails, () => dart.global.Object.setPrototypeOf({
    ...
    primaryVelocity: {type: T.doubleN(), isConst: false, isFinal: true, libraryUri: I[2]}
  ...
  dart_rti._Universe.addRules(dart.typeUniverse, JSON.parse('{"ui|Offset":{"ui|OffsetBase":[]},"core|Duration":{"Comparable.T":"core|Duration","core|Comparable":["core|Duration"]},"core|Comparable":{"Comparable.T":"1"},"ui|PointerDeviceKind":{"core|_Enum":[],"core|Enum":[]},"core|_Enum":{"core|Enum":[]},"core|double":{"core|num":[],"Comparable.T":"core|num","core|Comparable":["core|num"]},"core|num":{"Comparable.T":"core|num","core|Comparable":["core|num"]}}'));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["drag_details.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAmCe;;;;;;IAMA;;;;;;;;;;;;AAGQ,YAAG,AAA6D,0BAA3C,MAAM,qBAAmB,eAAE,uBAAc;IAAE;;;;QArB9E;QACG;IADH;IAEY,wBAAgB,QAAd,aAAa,EAAb,gBAAiB,cAAc;;;;;;;;;;;;;;;;;IAmDpC;;;;;;IAUH;;;;;;IAMA;;;;;;IAGY;;;;;;;;;;;;;;AAOJ,YAAG,AAA8D,0BAA5C,MAAM,sBAAoB,eAAE,uBAAc;IAAE;;;;QApC/E;QACA;QACG;QACH;IAHA;IACA;IAEA;IACY,yBAAgB,QAAd,aAAa,EAAb,gBAAiB,cAAc;;;;;;;;;;;;;;;;;;;;IA2EpC;;;;;;IAUH;;;;;;IAaC;;;;;;IAQD;;;;;;IAMA;;;;;;;;;;;;;;;AAGQ,YAAG,AAAsD,0BAApC,MAAM,uBAAqB,eAAE,cAAK;IAAE;;;;QAxDvE;QACA;QACA;QACS;QACN;IAJH;IACA;IACA;IACS;UAGT,AAAa,AAEX,YAFU,YACN,AAAa,YAAD,KAAI,AAAM,KAAD,OAAO,AAAM,AAAG,KAAJ,QAAO,OACxC,AAAa,YAAD,KAAI,AAAM,KAAD,OAAO,AAAM,AAAG,KAAJ,QAAO;IAElC,yBAAgB,QAAd,aAAa,EAAb,gBAAiB,cAAc;;;;;;;;;;;;;;;;;;;IAsFrC;;;;;;IAYD;;;;;;;;;;;;AAGO,YAAG,AAAsD,0BAApC,MAAM,oBAAkB,eAAE,iBAAQ;IAAE;;;QA1BvE;QACA;IADA;IACA;UAEA,AAAgB,AAEd,eAFa,YACT,AAAgB,eAAD,KAAI,AAAS,AAAgB,QAAjB,uBAAuB,AAAS,AAAgB,AAAG,QAApB,wBAAuB,KACjF,AAAgB,eAAD,KAAI,AAAS,AAAgB,QAAjB,uBAAuB,AAAS,AAAgB,AAAG,QAApB,wBAAuB;;EACxF","file":"../../../../../../../../../packages/flutter/src/gestures/drag_details.dart.lib.js"}');
  // Exports:
  return {
