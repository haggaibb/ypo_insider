...
define(['dart_sdk', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__gestures__lsq_solver_dart(dart_sdk, packages__flutter__src__foundation__object$46dart) {
  ...
  var T = {
    ...
    _VectorTodouble: () => (T._VectorTodouble = dart.constFn(dart_rti.findType("core|double(flutter__src__gestures__lsq_solver|_Vector)")))(),
    ...
    intTo_Vector: () => (T.intTo_Vector = dart.constFn(dart_rti.findType("flutter__src__gestures__lsq_solver|_Vector(core|int)")))(),
    String: () => (T.String = dart.constFn(dart_rti.findType("core|String")))(),
    doubleToString: () => (T.doubleToString = dart.constFn(dart_rti.findType("core|String(core|double)")))(),
    double: () => (T.double = dart.constFn(dart_rti.findType("core|double")))(),
    doubleN: () => (T.doubleN = dart.constFn(dart_rti.findType("core|double?")))(),
    intToPolynomialFitN: () => (T.intToPolynomialFitN = dart.constFn(dart_rti.findType("flutter__src__gestures__lsq_solver|PolynomialFit?(core|int)")))()
  };
  ...
  var I = [
    ...
    "dart:core",
    "file:///Users/haggaibarel/DEV/flutter/packages/flutter/lib/src/gestures/lsq_solver.dart"
  ];
  ...
  dart.setFieldSignature(lsq_solver._Vector, () => dart.global.Object.setPrototypeOf({
    [_offset]: {type: T.int(), isConst: false, isFinal: true, libraryUri: I[1]},
    [_length]: {type: T.int(), isConst: false, isFinal: true, libraryUri: I[1]},
    [_elements]: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[1]}
  ...
  dart.setMethodSignature(lsq_solver._Matrix, () => dart.global.Object.setPrototypeOf({
    get: T.intAndintTodouble(),
    set: T.intAndintAnddoubleTovoid(),
    getRow: T.intTo_Vector()
  ...
  dart.setFieldSignature(lsq_solver._Matrix, () => dart.global.Object.setPrototypeOf({
    [_columns]: {type: T.int(), isConst: false, isFinal: true, libraryUri: I[1]},
    [_elements]: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[1]}
  ...
  lsq_solver.PolynomialFit = class PolynomialFit extends core.Object {
    ...
    toString() {
      let coefficientString = dart.toString(this.coefficients[$map](T.String(), dart.fn(c => c[$toStringAsPrecision](3), T.doubleToString()))[$toList]());
  ...
  dart.setGetterSignature(lsq_solver.PolynomialFit, () => dart.global.Object.setPrototypeOf({confidence: T.double()}, dart.getGetters(dart.global.Object.getPrototypeOf(lsq_solver.PolynomialFit))));
  dart.setSetterSignature(lsq_solver.PolynomialFit, () => dart.global.Object.setPrototypeOf({confidence: T.double()}, dart.getSetters(dart.global.Object.getPrototypeOf(lsq_solver.PolynomialFit))));
  ...
  dart.setFieldSignature(lsq_solver.PolynomialFit, () => dart.global.Object.setPrototypeOf({
    coefficients: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[1]},
    [__PolynomialFit_confidence]: {type: T.doubleN(), isConst: false, isFinal: false, libraryUri: I[1]}
  ...
  (lsq_solver.LeastSquaresSolver.new = function(x, y, w) {
    ...
    this[y$] = y;
    this[w$] = w;
    if (!(x[$length] === y[$length])) dart.assertFailed(null, I[2], 99, 14, "x.length == y.length");
    if (!(y[$length] === w[$length])) dart.assertFailed(null, I[2], 100, 14, "y.length == w.length");
    ;
  ...
  dart.setMethodSignature(lsq_solver.LeastSquaresSolver, () => dart.global.Object.setPrototypeOf({solve: T.intToPolynomialFitN()}, dart.getMethods(dart.global.Object.getPrototypeOf(lsq_solver.LeastSquaresSolver))));
  ...
  dart.setFieldSignature(lsq_solver.LeastSquaresSolver, () => dart.global.Object.setPrototypeOf({
    x: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[1]},
    y: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[1]},
    w: {type: T.ListOfdouble(), isConst: false, isFinal: true, libraryUri: I[1]}
  ...
  }, '{"version":3,"sourceRoot":"","sources":["lsq_solver.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
AAS,IAAI,GAAG,AAAE,CAAD,GAAG,CAAC,EAAE,IAAA,AAAE,CAAD,GAAI;AACxB,YAAF,CAAC,KAAK,CAAC,EAAE,CAAC,EAAE,AAAE,AAAU,CAAX,KAAK,CAAC,EAAE,CAAC,IAAI,AAAI,GAAD,GAAG,AAAE,CAAD,KAAK,CAAC,EAAE,CAAC;;;AAIjC,mBAAO,AAAE,AAAU,CAAX,QAAQ,CAAC;AAC9B,YAAI,AAAK,IAAD;AAEN,gBAAO;;AAGI,0BAAc,AAAI,MAAE,IAAI;AACrC,iBAAS,IAAI,GAAG,AAAE,CAAD,GAAG,CAAC,EAAE,IAAA,AAAE,CAAD,GAAI;AACxB,UAAF,CAAC,KAAK,CAAC,EAAE,CAAC,EAAE,AAAE,AAAU,CAAX,KAAK,CAAC,EAAE,CAAC,IAAI,WAAW;;AAEvC,iBAAS,IAAI,GAAG,AAAE,CAAD,GAAG,CAAC,EAAE,IAAA,AAAE,CAAD,GAAI;AACxB,UAAF,CAAC,KAAK,CAAC,EAAE,CAAC,EAAE,AAAE,CAAD,GAAG,CAAC,GAAG,MAAM,AAAE,AAAU,CAAX,QAAQ,CAAC,OAAI,AAAE,CAAD,QAAQ,CAAC;;;AAMxC,eAAK,2BAAQ,CAAC;AAC5B,eAAS,IAAI,GAAG,AAAE,CAAD,GAAG,CAAC,EAAE,IAAA,AAAE,CAAD,GAAI;AACxB,QAAF,EAAE,MAAC,CAAC,EAAI,AAAC,AAAI,cAAH,CAAC,IAAI,AAAC,cAAC,CAAC;;AAEpB,eAAS,IAAI,AAAE,CAAD,GAAG,GAAG,AAAE,CAAD,IAAI,GAAG,IAAA,AAAE,CAAD,GAAI;AACZ,QAAnB,AAAO,MAAD,qBAAc,CAAC,EAAI,AAAE,AAAU,CAAX,QAAQ,CAAC,OAAI,EAAE;AACzC,iBAAS,IAAI,AAAE,CAAD,GAAG,GAAG,AAAE,CAAD,GAAG,CAAC,EAAE,IAAA,AAAE,CAAD,GAAI;AACP,kBAAvB,AAAO,MAAD;kBAAc,CAAC;UAAF,oBAAA,AAAI,sBAAG,AAAE,AAAU,CAAX,KAAK,CAAC,EAAE,CAAC,IAAI,AAAO,AAAY,MAAb,qBAAc,CAAC;;AAExC,iBAAvB,AAAO,MAAD;iBAAc,CAAC;QAAF,sBAAA,AAAI,wBAAG,AAAE,CAAD,KAAK,CAAC,EAAE,CAAC;;AAQ/B,kBAAQ;AACf,eAAS,IAAI,GAAG,AAAE,CAAD,GAAG,CAAC,EAAE,IAAA,AAAE,CAAD,GAAI;AAC1B,gBAAA,AAAM,KAAD,GAAI,AAAC,cAAC,CAAC;;AAEd,cAAA,AAAM,KAAD,GAAI,CAAC;AAEH,4BAAkB;AAClB,4BAAkB;AACzB,eAAS,IAAI,GAAG,AAAE,CAAD,GAAG,CAAC,EAAE,IAAA,AAAE,CAAD,GAAI;AACnB,mBAAO;AACP,kBAAM,AAAC,AAAI,cAAH,CAAC,IAAI,AAAO,AAAY,MAAb,qBAAc;AACxC,iBAAS,IAAI,GAAG,AAAE,CAAD,GAAG,CAAC,EAAE,IAAA,AAAE,CAAD,GAAI;AAC1B,iBAAA,AAAK,IAAD,GAAI,AAAC,cAAC,CAAC;AACX,gBAAA,AAAI,GAAD,GAAI,AAAK,IAAD,GAAG,AAAO,AAAY,MAAb,qBAAc,CAAC;;AAErC,0BAAA,AAAgB,eAAD,GAAI,AAAC,AAAI,AAAO,AAAM,cAAhB,CAAC,IAAI,AAAC,cAAC,CAAC,IAAI,GAAG,GAAG,GAAG;AAC7B,gBAAI,AAAC,AAAI,cAAH,CAAC,IAAI,KAAK;AAC7B,0BAAA,AAAgB,eAAD,GAAI,AAAC,AAAI,AAAO,AAAI,cAAd,CAAC,IAAI,AAAC,cAAC,CAAC,IAAI,CAAC,GAAG,CAAC;;AAGjC,MAAP,MAAM,cAAc,AAAgB,eAAD,YAA8B,MAC3C,AAAI,MAAG,AAAgB,eAAD,GAAG,eAAe;AAE9D,YAAO,OAAM;IACf;;gDAhHwB,GAAQ,GAAQ;IAAhB;IAAQ;IAAQ;UAC7B,AAAE,AAAO,CAAR,cAAW,AAAE,CAAD;UACb,AAAE,AAAO,CAAR,cAAW,AAAE,CAAD;;EAAQ","file":"../../../../../../../../../packages/flutter/src/gestures/lsq_solver.dart.lib.js"}');
  // Exports:
  return {
