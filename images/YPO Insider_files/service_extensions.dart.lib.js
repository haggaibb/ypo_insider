...
define(['dart_sdk'], (function load__packages__flutter__src__rendering__service_extensions_dart(dart_sdk) {
  ...
  var T = {
    ...
    ListOfRenderingServiceExtensions: () => (T.ListOfRenderingServiceExtensions = dart.constFn(dart_rti.findType("core|List<flutter__src__rendering__service_extensions|RenderingServiceExtensions>")))(),
    RenderingServiceExtensions: () => (T.RenderingServiceExtensions = dart.constFn(dart_rti.findType("flutter__src__rendering__service_extensions|RenderingServiceExtensions")))()
  };
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C[0] = dart.constList([C[1] || CT.C1, C[2] || CT.C2, C[3] || CT.C3, C[4] || CT.C4, C[5] || CT.C5, C[6] || CT.C6, C[7] || CT.C7, C[8] || CT.C8, C[9] || CT.C9, C[10] || CT.C10, C[11] || CT.C11, C[12] || CT.C12, C[13] || CT.C13], T.RenderingServiceExtensions());
    }
  }, false);
  ...
  dart.setMethodSignature(service_extensions.RenderingServiceExtensions, () => dart.global.Object.setPrototypeOf({[_enumToString]: T.VoidToString()}, dart.getMethods(dart.global.Object.getPrototypeOf(service_extensions.RenderingServiceExtensions))));
