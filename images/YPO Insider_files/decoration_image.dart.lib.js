...
define(['dart_sdk', 'packages/flutter/src/painting/alignment.dart', 'packages/flutter/src/painting/box_fit.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/image_stream.dart', 'packages/flutter/src/painting/binding.dart', 'packages/flutter/src/painting/debug.dart', 'packages/flutter/src/scheduler/binding.dart'], (function load__packages__flutter__src__painting__decoration_image_dart(dart_sdk, packages__flutter__src__painting__alignment$46dart, packages__flutter__src__painting__box_fit$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__image_stream$46dart, packages__flutter__src__painting__binding$46dart, packages__flutter__src__painting__debug$46dart, packages__flutter__src__scheduler__binding$46dart) {
  'use strict';
  ...
  var T = {
    ...
    ListOfImageRepeat: () => (T.ListOfImageRepeat = dart.constFn(dart_rti.findType("core|List<flutter__src__painting__decoration_image|ImageRepeat>")))(),
    ImageRepeat: () => (T.ImageRepeat = dart.constFn(dart_rti.findType("flutter__src__painting__decoration_image|ImageRepeat")))(),
    ...
    FnToDecorationImagePainter: () => (T.FnToDecorationImagePainter = dart.constFn(dart_rti.findType("flutter__src__painting__decoration_image|DecorationImagePainter(~())")))(),
    DecorationImageNAndDecorationImageNAnddoubleToDecorationImageN: () => (T.DecorationImageNAndDecorationImageNAnddoubleToDecorationImageN = dart.constFn(dart_rti.findType("flutter__src__painting__decoration_image|DecorationImage?(flutter__src__painting__decoration_image|DecorationImage?,flutter__src__painting__decoration_image|DecorationImage?,core|double)")))(),
    ...
    ColorFilterN: () => (T.ColorFilterN = dart.constFn(dart_rti.findType("ui|ColorFilter?")))(),
    BoxFitN: () => (T.BoxFitN = dart.constFn(dart_rti.findType("flutter__src__painting__box_fit|BoxFit?")))(),
    ...
    FilterQuality: () => (T.FilterQuality = dart.constFn(dart_rti.findType("ui|FilterQuality")))(),
    ...
    CanvasAndRectAndPathN__Tovoid: () => (T.CanvasAndRectAndPathN__Tovoid = dart.constFn(dart_rti.findType("~(ui|Canvas,ui|Rect,ui|Path?,flutter__src__painting__image_provider|ImageConfiguration{blend:core|double,blendMode:ui|BlendMode})")))(),
    ...
    ImageStreamN: () => (T.ImageStreamN = dart.constFn(dart_rti.findType("flutter__src__painting__image_stream|ImageStream?")))(),
    ImageInfoN: () => (T.ImageInfoN = dart.constFn(dart_rti.findType("flutter__src__painting__image_stream|ImageInfo?")))(),
    _BlendedDecorationImage: () => (T._BlendedDecorationImage = dart.constFn(dart_rti.findType("flutter__src__painting__decoration_image|_BlendedDecorationImage")))(),
    ...
    ImageSizeInfo: () => (T.ImageSizeInfo = dart.constFn(dart_rti.findType("flutter__src__painting__debug|ImageSizeInfo")))(),
    Offset: () => (T.Offset = dart.constFn(dart_rti.findType("ui|Offset")))(),
    Size: () => (T.Size = dart.constFn(dart_rti.findType("ui|Size")))(),
    doubleAndFlutterViewTodouble: () => (T.doubleAndFlutterViewTodouble = dart.constFn(dart_rti.findType("core|double(core|double,ui|FlutterView)")))(),
  ...
  var G = {
    ...
    LinkedHashSetOfImageSizeInfo: () => (G.LinkedHashSetOfImageSizeInfo = dart.constFn(collection.LinkedHashSet$(T.ImageSizeInfo())))(),
    IdentityMapOfString$Object: () => (G.IdentityMapOfString$Object = dart.constFn(_js_helper.IdentityMap$(T.String(), T.Object())))(),
    IdentityMapOfString$ImageSizeInfo: () => (G.IdentityMapOfString$ImageSizeInfo = dart.constFn(_js_helper.IdentityMap$(T.String(), T.ImageSizeInfo())))(),
    JSArrayOfRect: () => (G.JSArrayOfRect = dart.constFn(_interceptors.JSArray$(T.Rect())))()
  };
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C[0] = dart.constList([C[1] || CT.C1, C[2] || CT.C2, C[3] || CT.C3, C[4] || CT.C4], T.ImageRepeat());
    },
    get C5() {
    ...
    get C10() {
      return C[10] = dart.constList([-1, 0, 0, 0, 255, 0, -1, 0, 0, 255, 0, 0, -1, 0, 255, 0, 0, 0, 1, 0], T.double());
    },
    get C8() {
  ...
  var I = [
    ...
    "file:///Users/haggaibarel/DEV/flutter/packages/flutter/lib/src/painting/decoration_image.dart",
  ...
  dart.setMethodSignature(decoration_image.ImageRepeat, () => dart.global.Object.setPrototypeOf({[_enumToString]: T.VoidToString()}, dart.getMethods(dart.global.Object.getPrototypeOf(decoration_image.ImageRepeat))));
  ...
  decoration_image.DecorationImage = class DecorationImage extends core.Object {
    ...
    toString() {
      let properties = (() => {
        let t$362 = G.JSArrayOfString().of([dart.str(this.image)]);
  ...
  dart.setMethodSignature(decoration_image.DecorationImage, () => dart.global.Object.setPrototypeOf({createPainter: T.FnToDecorationImagePainter()}, dart.getMethods(dart.global.Object.getPrototypeOf(decoration_image.DecorationImage))));
  ...
  dart.setFieldSignature(decoration_image.DecorationImage, () => dart.global.Object.setPrototypeOf({
    image: {type: T.ImageProviderOfObject(), isConst: false, isFinal: true, libraryUri: I[2]},
    onError: {type: T.ObjectAndStackTraceNToNvoid(), isConst: false, isFinal: true},
    colorFilter: {type: T.ColorFilterN(), isConst: false, isFinal: true, libraryUri: I[3]},
    fit: {type: T.BoxFitN(), isConst: false, isFinal: true, libraryUri: I[4]},
    alignment: {type: T.AlignmentGeometry(), isConst: false, isFinal: true, libraryUri: I[5]},
    centerSlice: {type: T.RectN(), isConst: false, isFinal: true, libraryUri: I[3]},
    repeat: {type: T.ImageRepeat(), isConst: false, isFinal: true, libraryUri: I[0]},
    matchTextDirection: {type: T.bool(), isConst: false, isFinal: true, libraryUri: I[1]},
    scale: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[1]},
    opacity: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[1]},
    filterQuality: {type: T.FilterQuality(), isConst: false, isFinal: true, libraryUri: I[3]},
    invertColors: {type: T.bool(), isConst: false, isFinal: true, libraryUri: I[1]},
    isAntiAlias: {type: T.bool(), isConst: false, isFinal: true, libraryUri: I[1]}
      ...
      if (this[_details$].matchTextDirection) {
        if (!dart.fn(() => {
          if (configuration.textDirection == null) {
            dart.throw(new assertions.FlutterError.fromParts(G.JSArrayOfDiagnosticsNode().of([new assertions.ErrorSummary.new("DecorationImage.matchTextDirection can only be used when a TextDirection is available."), new assertions.ErrorDescription.new("When DecorationImagePainter.paint() was called, there was no text direction provided in the ImageConfiguration object to match."), new (G.DiagnosticsPropertyOfDecorationImage()).new("The DecorationImage was", this[_details$], {style: diagnostics.DiagnosticsTreeStyle.errorProperty}), new (G.DiagnosticsPropertyOfImageConfiguration()).new("The ImageConfiguration was", configuration, {style: diagnostics.DiagnosticsTreeStyle.errorProperty})])));
          }
          return true;
        }, T.VoidTobool())()) dart.assertFailed(null, I[6], 326, 14, "() {\n        // We check this first so that the assert will fire immediately, not just\n        // when the image is ready.\n        if (configuration.textDirection == null) {\n          throw FlutterError.fromParts(<DiagnosticsNode>[\n            ErrorSummary('DecorationImage.matchTextDirection can only be used when a TextDirection is available.'),\n            ErrorDescription(\n              'When DecorationImagePainter.paint() was called, there was no text direction provided '\n              'in the ImageConfiguration object to match.',\n            ),\n            DiagnosticsProperty<DecorationImage>('The DecorationImage was', _details, style: DiagnosticsTreeStyle.errorProperty),\n            DiagnosticsProperty<ImageConfiguration>('The ImageConfiguration was', configuration, style: DiagnosticsTreeStyle.errorProperty),\n          ]);\n        }\n        return true;\n      }()");
  ...
  dart.addTypeTests(decoration_image._DecorationImagePainter);
  ...
  dart.addTypeCaches(decoration_image._DecorationImagePainter);
  dart.setMethodSignature(decoration_image._DecorationImagePainter, () => dart.global.Object.setPrototypeOf({
    paint: T.CanvasAndRectAndPathN__Tovoid(),
    [_handleImage]: T.ImageInfoAndboolTovoid(),
  ...
  dart.setFieldSignature(decoration_image._DecorationImagePainter, () => dart.global.Object.setPrototypeOf({
    [_details$]: {type: T.DecorationImage(), isConst: false, isFinal: true, libraryUri: I[0]},
    [_onChanged$]: {type: T.VoidTovoid(), isConst: false, isFinal: true},
    [_imageStream]: {type: T.ImageStreamN(), isConst: false, isFinal: false, libraryUri: I[7]},
    [_image]: {type: T.ImageInfoN(), isConst: false, isFinal: false, libraryUri: I[7]}
  ...
  (decoration_image._BlendedDecorationImage.new = function(a, b, t) {
    ...
    this[b$] = b;
    this[t$] = t;
    if (!(a != null || b != null)) dart.assertFailed(null, I[6], 738, 66, "a != null || b != null");
    ;
  }).prototype = decoration_image._BlendedDecorationImage.prototype;
  dart.addTypeTests(decoration_image._BlendedDecorationImage);
  ...
  dart.addTypeCaches(decoration_image._BlendedDecorationImage);
  dart.setMethodSignature(decoration_image._BlendedDecorationImage, () => dart.global.Object.setPrototypeOf({createPainter: T.FnToDecorationImagePainter()}, dart.getMethods(dart.global.Object.getPrototypeOf(decoration_image._BlendedDecorationImage))));
  dart.setGetterSignature(decoration_image._BlendedDecorationImage, () => dart.global.Object.setPrototypeOf({
    image: T.ImageProviderOfObject(),
    onError: T.ObjectAndStackTraceNToNvoid(),
    colorFilter: T.ColorFilterN(),
    fit: T.BoxFitN(),
    alignment: T.AlignmentGeometry(),
    centerSlice: T.RectN(),
    repeat: T.ImageRepeat(),
    matchTextDirection: T.bool(),
    scale: T.double(),
    opacity: T.double(),
  ...
  dart.setFieldSignature(decoration_image._BlendedDecorationImage, () => dart.global.Object.setPrototypeOf({
    a: {type: T.DecorationImageN(), isConst: false, isFinal: true, libraryUri: I[0]},
    b: {type: T.DecorationImageN(), isConst: false, isFinal: true, libraryUri: I[0]},
  ...
  dart.addTypeTests(decoration_image._BlendedDecorationImagePainter);
  ...
  dart.addTypeCaches(decoration_image._BlendedDecorationImagePainter);
  ...
  dart.setFieldSignature(decoration_image._BlendedDecorationImagePainter, () => dart.global.Object.setPrototypeOf({
    a: {type: T.DecorationImagePainterN(), isConst: false, isFinal: true, libraryUri: I[0]},
    b: {type: T.DecorationImagePainterN(), isConst: false, isFinal: true, libraryUri: I[0]},
    t: {type: T.double(), isConst: false, isFinal: true, libraryUri: I[1]}
  ...
  decoration_image.debugFlushLastFrameImageSizeInfo = function debugFlushLastFrameImageSizeInfo() {
    if (!dart.fn(() => {
      decoration_image._lastFrameImageSizeInfo = G.LinkedHashSetOfImageSizeInfo().new();
      return true;
    }, T.VoidTobool())()) dart.assertFailed(null, I[6], 434, 10, "() {\n    _lastFrameImageSizeInfo = <ImageSizeInfo>{};\n    return true;\n  }()");
  };
  decoration_image.paintImage = function paintImage(opts) {
    ...
    if (!(centerSlice == null || fit !== box_fit.BoxFit.none && fit !== box_fit.BoxFit.cover)) dart.assertFailed(null, I[6], 543, 10, "centerSlice == null || (fit != BoxFit.none && fit != BoxFit.cover)");
    ...
    if (centerSlice != null) {
      ...
      if (!dart.equals(sourceSize, inputSize)) dart.assertFailed("centerSlice was used with a BoxFit that does not guarantee that the image is fully visible.", I[6], 552, 12, "sourceSize == inputSize");
    }
    ...
    {
      let maxDevicePixelRatio = binding.PaintingBinding.instance.platformDispatcher.views[$fold](T.double(), 0.0, dart.fn((previousValue, view) => math.max(T.double(), previousValue, view.devicePixelRatio), T.doubleAndFlutterViewTodouble()));
      ...
      if (!decoration_image._lastFrameImageSizeInfo.contains(sizeInfo)) {
        ...
        binding$.SchedulerBinding.instance.addPostFrameCallback(dart.fn(timeStamp => {
          ...
          developer.postEvent("Flutter.ImageSizesForFrame", (() => {
            let t$363 = new (G.IdentityMapOfString$Object()).new();
          ...
          decoration_image._pendingImageSizeInfo = new (G.IdentityMapOfString$ImageSizeInfo()).new();
  ...
  dart.defineLazy(decoration_image, {
    /*decoration_image._pendingImageSizeInfo*/get _pendingImageSizeInfo() {
      return new (G.IdentityMapOfString$ImageSizeInfo()).new();
    },
    set _pendingImageSizeInfo(value) {},
    /*decoration_image._lastFrameImageSizeInfo*/get _lastFrameImageSizeInfo() {
      return G.LinkedHashSetOfImageSizeInfo().new();
    },
    set _lastFrameImageSizeInfo(value) {}
  }, false);
  dart.moduleConstCaches.set("packages/flutter/src/painting/decoration_image.dart", C);
  dart_rti._Universe.addRules(dart.typeUniverse, JSON.parse('{"core|String":{"Comparable.T":"core|String","core|Comparable":["core|String"],"core|Pattern":[]},"core|Comparable":{"Comparable.T":"1"},"core|List":{"List.E":"1","Iterable.E":"1","core|Iterable":["1"],"_ListIterable.E":"1","core|_ListIterable":["1"],"EfficientLengthIterable.T":"1","_internal|EfficientLengthIterable":["1"],"HideEfficientLengthIterable.T":"1","_internal|HideEfficientLengthIterable":["1"]},"core|Iterable":{"Iterable.E":"1"},"core|_ListIterable":{"_ListIterable.E":"1","EfficientLengthIterable.T":"1","_internal|EfficientLengthIterable":["1"],"HideEfficientLengthIterable.T":"1","_internal|HideEfficientLengthIterable":["1"],"Iterable.E":"1","core|Iterable":["1"]},"_internal|EfficientLengthIterable":{"EfficientLengthIterable.T":"1","Iterable.E":"1","core|Iterable":["1"]},"_internal|HideEfficientLengthIterable":{"HideEfficientLengthIterable.T":"1","Iterable.E":"1","core|Iterable":["1"]},"flutter__src__painting__decoration_image|ImageRepeat":{"core|_Enum":[],"core|Enum":[]},"core|_Enum":{"core|Enum":[]},"core|double":{"core|num":[],"Comparable.T":"core|num","core|Comparable":["core|num"]},"core|num":{"Comparable.T":"core|num","core|Comparable":["core|num"]},"flutter__src__painting__image_provider|ImageProvider":{"ImageProvider.T":"1"},"ui|ColorFilter":{"ui|ImageFilter":[]},"flutter__src__painting__box_fit|BoxFit":{"core|_Enum":[],"core|Enum":[]},"ui|FilterQuality":{"core|_Enum":[],"core|Enum":[]},"ui|BlendMode":{"core|_Enum":[],"core|Enum":[]},"flutter__src__painting__image_stream|ImageStream":{"flutter__src__foundation__diagnostics|Diagnosticable":[]},"flutter__src__painting__decoration_image|_BlendedDecorationImage":{"flutter__src__painting__decoration_image|DecorationImage":[]},"ui|Offset":{"ui|OffsetBase":[]},"ui|Size":{"ui|OffsetBase":[]},"core|Duration":{"Comparable.T":"core|Duration","core|Comparable":["core|Duration"]},"flutter__src__painting__decoration_image|_DecorationImagePainter":{"flutter__src__painting__decoration_image|DecorationImagePainter":[]},"flutter__src__painting__decoration_image|_BlendedDecorationImagePainter":{"flutter__src__painting__decoration_image|DecorationImagePainter":[]}}'));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["decoration_image.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAiCA;;;;;;;;;;;;;MAZK,mCAAM;;;MAET,mCAAM;;;MAGN,oCAAO;;;MAGP,oCAAO;;;MAGP,qCAAQ;;;;;;;;;;;;;;;;;;;;;IA8BY;;;;;;IAGM;;;;;;IAGP;;;;;;IAQL;;;;;;IA2BU;;;;;;IAiBZ;;;;;;IAIM;;;;;;IASP;;;;;;IAME;;;;;;IAOA;;;;;;IAMO;;;;;;IAWT;;;;;;IAKA;;;;;;;;;;;;;;;;;;;;;;kBAOuC;AAChD,YAA+B,iDAAE,MAAM,SAAS;IAClD;YAGwB;;AACtB,UAAI,AAAU,SAAM,KAAK;AACvB,cAAO;;AAET,uBAAU,iBAAN,KAAK,oBAAgB;AACvB,cAAO;;AAET,YAAa,AAYT,0BAZG,KAAK,KACO,YAAZ,AAAM,KAAD,QAAU,eACG,YAAlB,AAAM,KAAD,cAAgB,qBACrB,AAAM,AAAI,KAAL,QAAQ,YACG,YAAhB,AAAM,KAAD,YAAc,mBACD,YAAlB,AAAM,KAAD,cAAgB,qBACrB,AAAM,AAAO,KAAR,YAAW,eAChB,AAAM,AAAmB,KAApB,wBAAuB,2BAC5B,AAAM,AAAM,KAAP,WAAU,cACf,AAAM,AAAQ,KAAT,aAAY,gBACjB,AAAM,AAAc,KAAf,mBAAkB,sBACvB,AAAM,AAAa,KAAd,kBAAiB,qBACtB,AAAM,AAAY,KAAb,iBAAgB;IAC9B;;AAGoB,YAAO,kBACzB,YACA,kBACA,UACA,gBACA,kBACA,aACA,yBACA,YACA,cACA,oBACA,mBACA;IACD;;AAIoB,uBAAqB;4CAC9B,SAAN;AACF,YAAI,0BACY,oBAAZ;A