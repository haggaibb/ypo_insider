...
// Module: packages/characters/src/grapheme_clusters/breaks.dart
...
define(['dart_sdk', 'packages/characters/src/grapheme_clusters/table.dart'], (function load__packages__characters__src__grapheme_clusters__breaks_dart(dart_sdk, packages__characters__src__grapheme_clusters__table$46dart) {
  ...
  var I = [
    ...
    "dart:core",
    "file:///Users/haggaibarel/.pub-cache/hosted/pub.dev/characters-1.3.0/lib/src/grapheme_clusters/breaks.dart"
  ];
  ...
  breaks.Breaks = class Breaks extends core.Object {
    ...
    nextBreak() {
      ...
      while (this.cursor < this.end) {
        ...
        let char = this.base[$codeUnitAt]((t$360 = this.cursor, this.cursor = t$360 + 1, t$360));
        if ((char & 64512) !== 55296) {
  ...
  dart.addRtiResources(breaks.Breaks, ["characters__src__grapheme_clusters__breaks|Breaks"]);
  dart.addTypeCaches(breaks.Breaks);
  dart.setMethodSignature(breaks.Breaks, () => dart.global.Object.setPrototypeOf({
    copy: T.VoidToBreaks(),
    nextBreak: T.VoidToint()
  }, dart.getMethods(dart.global.Object.getPrototypeOf(breaks.Breaks))));
  dart.setLibraryUri(breaks.Breaks, I[0]);
  dart.setFieldSignature(breaks.Breaks, () => dart.global.Object.setPrototypeOf({
    base: {type: T.String(), isConst: false, isFinal: true, libraryUri: I[1]},
    end: {type: T.int(), isConst: false, isFinal: true, libraryUri: I[1]},
    cursor: {type: T.int(), isConst: false, isFinal: false, libraryUri: I[1]},
    state: {type: T.int(), isConst: false, isFinal: false, libraryUri: I[1]}
  }, dart.getFields(dart.global.Object.getPrototypeOf(breaks.Breaks))));
  ...
  dart.addRtiResources(breaks.BackBreaks, ["characters__src__grapheme_clusters__breaks|BackBreaks"]);
  dart.addTypeCaches(breaks.BackBreaks);
  dart.setMethodSignature(breaks.BackBreaks, () => dart.global.Object.setPrototypeOf({
    copy: T.VoidToBackBreaks(),
    nextBreak: T.VoidToint(),
    [_lookAhead]: T.intToint()
  }, dart.getMethods(dart.global.Object.getPrototypeOf(breaks.BackBreaks))));
  dart.setLibraryUri(breaks.BackBreaks, I[0]);
  dart.setFieldSignature(breaks.BackBreaks, () => dart.global.Object.setPrototypeOf({
    base: {type: T.String(), isConst: false, isFinal: true, libraryUri: I[1]},
    start: {type: T.int(), isConst: false, isFinal: true, libraryUri: I[1]},
    cursor: {type: T.int(), isConst: false, isFinal: false, libraryUri: I[1]},
    state: {type: T.int(), isConst: false, isFinal: false, libraryUri: I[1]}
  }, dart.getFields(dart.global.Object.getPrototypeOf(breaks.BackBreaks))));
  breaks.lookAhead = function lookAhead(base, start, cursor, state) {
    if (!(state >= 208)) dart.assertFailed(null, I[2], 156, 10, "state >= stateLookaheadMin");
    if (state === 208) {
  ...
  breaks.isGraphemeClusterBoundary = function isGraphemeClusterBoundary(text, start, end, index) {
    if (!(0 <= start)) dart.assertFailed(null, I[2], 237, 10, "0 <= start");
    if (!(start <= index)) dart.assertFailed(null, I[2], 238, 10, "start <= index");
    if (!(index <= end)) dart.assertFailed(null, I[2], 239, 10, "index <= end");
    if (!(end <= text.length)) dart.assertFailed(null, I[2], 240, 10, "end <= text.length");
    if (start < index && index < end) {
      ...
      if (!(state < 208)) dart.assertFailed(null, I[2], 287, 12, "state < stateLookaheadMin");
  ...
  breaks.previousBreak = function previousBreak(text, start, end, index) {
    if (!(0 <= start)) dart.assertFailed(null, I[2], 301, 10, "0 <= start");
    if (!(start <= index)) dart.assertFailed(null, I[2], 302, 10, "start <= index");
    if (!(index <= end)) dart.assertFailed(null, I[2], 303, 10, "index <= end");
    if (!(end <= text.length)) dart.assertFailed(null, I[2], 304, 10, "end <= text.length");
  ...
  breaks.nextBreak = function nextBreak(text, start, end, index) {
    if (!(0 <= start)) dart.assertFailed(null, I[2], 335, 10, "0 <= start");
    if (!(start <= index)) dart.assertFailed(null, I[2], 336, 10, "start <= index");
    if (!(index <= end)) dart.assertFailed(null, I[2], 337, 10, "index <= end");
    if (!(end <= text.length)) dart.assertFailed(null, I[2], 338, 10, "end <= text.length");
    if (index === start || index === end) return index;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["breaks.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAyBe;;;;;;IAGH;;;;;;IAGN;;;;;;IAGA;;;;;;;;;;AAKa,mCAAO,WAAM,aAAQ,UAAK;IAAM;;;AAO/C,aAAO,AAAO,cAAE;AACV,sBAAU;AACV,mBAAO,AAAK,wBAAiB,qBAAN,sBAAM;AACjC,aAAI,AAAK,IAAD,GAAG,WAAU;AACnB,uBAAQ,WAAK,YAAO,UAAI,IAAI;AAC5B,cAAyB,CAArB,AAAM,oBAAkB;AAC1B,kBAAO,QAAO;;AAEhB;;AAGE;AACJ,YAAI,AAAO,cAAE;AACP,yBAAW,AAAK,uBAAW;AAC/B,cAAsB,CAAlB,AAAS,QAAD,GAAG,WAAU;AACvB,uBAAW,WAAK,IAAI,EAAE,QAAQ;AAC9B,0BAAA,AAAM,cAAA;;;AAGV,qBAAQ,WAAK,YAAO,QAAQ;AAC5B,YAAyB,CAArB,AAAM,oBAAkB;AAC1B,gBAAO,QAAO;;;AAGlB,mBAAQ,WAAK;AACb,UAAyB,CAArB,AAAM,oBAAkB,GAAG,MAAO;AACtC,YAAO,EAAC;IACV;;gCArCY,MAAW,QAAa,KAAU;IAAlC;IAAW;IAAa;IAAU;;EAAM;;;;;;;;;;;;;;;;;;;;;IA0DvC;;;;;;IAGH;;;;;;IAGN;;;;;;IAGA;;;;;;;;;;AAGiB,uCAAW,WAAM,aAAQ,YAAO;IAAM;;AAOzD,aAAO,AAAO,cAAE;AACV,sBAAU;AACV,mBAAO,AAAK,uBAAa,cAAF,AAAE,cAAF;AAC3B,aAAI,AAAK,IAAD,GAAG,WAAU;AACnB,uBAAQ,eAAS,YAAO,UAAI,IAAI;AAChC,cAAI,AAAM,mBAAsB,aAAQ,iBAAW;AACnD,cAAyB,CAArB,AAAM,oBAAkB;AAC1B,kBAAO,QAAO;;AAEhB;;AAGE;AACJ,YAAI,AAAO,eAAG;AACR,yBAAW,AAAK,u
M,KAAD,GAAG;AACzB,UAAI,AAAW,UAAD,GAAG,GAAG;AACd,yBAAa,AAAK,IAAD,cAAY,UAAU;AAC3C,YAAwB,CAApB,AAAW,UAAD,GAAG,WAAU;AACzB,qBAAW,WAAK,QAAQ,EAAE,UAAU;;;;AAIpC,qBAAW,AAAK,IAAD,cAAY,AAAM,KAAD,GAAG;AACvC,UAAsB,CAAlB,AAAS,QAAD,GAAG,WAAU;AACvB,mBAAW,WAAK,QAAQ,EAAE,QAAQ;AAClC,sBAAA,AAAY,WAAD,GAAI;;;AAGnB,UAAO,AAEF,2BADG,IAAI,EAAE,WAAW,EAAE,KAAK,EAAE,oBAA0B,QAAQ;EAEtE;wCAKqB,MAAU,OAAW,KAAS;AACjD,UAAO,AAAE,KAAG,KAAK;AACjB,UAAO,AAAM,KAAD,IAAI,KAAK;AACrB,UAAO,AAAM,KAAD,IAAI,GAAG;AACnB,UAAO,AAAI,GAAD,IAAI,AAAK,IAAD;AAClB,QAAI,AAAM,KAAD,KAAI,KAAK,IAAI,AAAM,KAAD,KAAI,GAAG,EAAE,MAAO,MAAK;AAC5C,sBAAc,AAAM,KAAD,GAAG;AACtB,mBAAW,AAAK,IAAD,cAAY,WAAW;AACtC;AACJ,SAAI,AAAS,QAAD,GAAG,WAAU;AACvB,qBAAe,UAAI,QAAQ;UACtB,KAAsB,CAAlB,AAAS,QAAD,GAAG,WAAU;AAC1B,qBAAW,AAAK,IAAD,cAAY,KAAK;AACpC,UAAsB,CAAlB,AAAS,QAAD,GAAG,WAAU;AACvB,gBAAA,AAAM,KAAD,GAAI;AACT,YAAI,AAAM,KAAD,KAAI,GAAG,EAAE,MAAO,IAAG;AAC5B,uBAAe,WAAK,QAAQ,EAAE,QAAQ;;UAEnC,KAAI,AAAY,WAAD,GAAG,KAAK;AACxB,4BAAkB,AAAY,WAAD,GAAG;AAChC,uBAAa,AAAK,IAAD,cAAY,eAAe;AAChD,UAAwB,CAApB,AAAW,UAAD,GAAG,WAAU;AACzB,sBAAc,eAAe;AAC7B,uBAAe,WAAK,UAAU,EAAE,QAAQ;;;AAOxC;AACJ,QAAI,AAAa,YAAD;AACV,sBAAY,yBAAkB,IAAI,EAAE,KAAK,EAAE,WAAW;AAC1D,UAAI,SAAS;AACX;;UAEG,KAAI,AAAa,YAAD,UAAmB,AAAa,YAAD;AAChD,oBAAU,oCAA6B,IAAI,EAAE,KAAK,EAAE,WAAW;AACnE,UAAI,AAAQ,OAAD,IAAI;AACb,gBAAQ,AAAa,YAAD;;;AAKtB,cAAQ,gBAAsB,YAAY;;AAE5C,UAAO,AAAwC,uBAAjC,IAAI,EAAE,KAAK,EAAE,AAAK,IAAD,SAAS,KAAK;EAC/C","file":"../../../../../../../../../packages/characters/src/grapheme_clusters/breaks.dart.lib.js"}');
  // Exports:
  return {
