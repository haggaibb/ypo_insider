...
define(['dart_sdk', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__services__keyboard_inserted_content_dart(dart_sdk, packages__flutter__src__foundation__object$46dart) {
  ...
  var T = {
    ...
    KeyboardInsertedContent: () => (T.KeyboardInsertedContent = dart.constFn(dart_rti.findType("flutter__src__services__keyboard_inserted_content|KeyboardInsertedContent")))(),
  ...
  (keyboard_inserted_content.KeyboardInsertedContent.fromJson = function(metadata) {
    this[mimeType$] = T.String()[_as](metadata[$_get]("mimeType"));
    this[uri$] = T.String()[_as](metadata[$_get]("uri"));
    this[data$] = metadata[$_get]("data") != null ? _native_typed_data.NativeUint8List.fromList(G.ListOfint().from(T.Iterable()[_as](metadata[$_get]("data")))) : null;
    ;
  }).prototype = keyboard_inserted_content.KeyboardInsertedContent.prototype;
  ...
  dart.setGetterSignature(keyboard_inserted_content.KeyboardInsertedContent, () => dart.global.Object.setPrototypeOf({hasData: T.bool()}, dart.getGetters(dart.global.Object.getPrototypeOf(keyboard_inserted_content.KeyboardInsertedContent))));
  ...
  dart.setFieldSignature(keyboard_inserted_content.KeyboardInsertedContent, () => dart.global.Object.setPrototypeOf({
    mimeType: {type: T.String(), isConst: false, isFinal: true, libraryUri: I[1]},
    uri: {type: T.String(), isConst: false, isFinal: true, libraryUri: I[1]},
    data: {type: T.Uint8ListN(), isConst: false, isFinal: true, libraryUri: I[2]}
  ...
  }, '{"version":3,"sourceRoot":"","sources":["keyboard_inserted_content.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA8Be;;;;;;IAGA;;;;;;IAGI;;;;;;;;;;;;;;;;;AAGG,0DAAM;YAAN,kBAAoB;IAAK;;AAGxB,YAAG,AAA4E,0BAA1D,MAAM,6BAA2B,MAAE,gBAAQ,OAAG,WAAG,gBAAG,aAAI;IAAE;YAG5E;;AACtB,uBAAU,iBAAN,KAAK,oBAAgB;AACvB,cAAO;;AAET,YAAa,AAGT,kCAHG,KAAK,KACL,AAAM,AAAS,KAAV,cAAa,iBAClB,AAAM,AAAI,KAAL,SAAQ,YACF,YAAX,AAAM,KAAD,OAAS;IACvB;;AAGoB,YAAO,kBAAK,eAAU,UAAK;IAAK;;;QArCP;QAAwB;QAAU;IAAlC;IAAwB;IAAU;;EAAM;yEAG/B;IACzC,kBAAuB,gBAArB,AAAQ,QAAA,QAAC;IAChB,aAAkB,gBAAhB,AAAQ,QAAA,QAAC;IACV,cAAE,AAAQ,AAAS,QAAT,QAAC,kBACA,4CAAS,mBAAgC,kBAAjB,AAAQ,QAAA,QAAC,aAC3C;;EAAI","file":"../../../../../../../../../packages/flutter/src/services/keyboard_inserted_content.dart.lib.js"}');
  // Exports:
  return {
