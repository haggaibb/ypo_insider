...
// Module: packages/get/get_utils/src/platform/platform_web.dart
// Flags: newRuntimeTypes(true), soundNullSafety(true), enableAsserts(true)
define(['dart_sdk', 'packages/get/get_utils/src/get_utils/get_utils.dart', 'packages/flutter/src/widgets/unique_widget.dart', 'packages/flutter/src/material/time.dart'], (function load__packages__get__get_utils__src__platform__platform_web_dart(dart_sdk, packages__get__get_utils__src__get_utils__get_utils$46dart, packages__flutter__src__widgets__unique_widget$46dart, packages__flutter__src__material__time$46dart) {
  'use strict';
  ...
  var T = {
    ...
    __Todouble: () => (T.__Todouble = dart.constFn(dart_rti.findType("core|double({dividedBy:core|double,reducedBy:core|double})")))(),
    __Todouble$1: () => (T.__Todouble$1 = dart.constFn(dart_rti.findType("core|double({dividedBy:core|double,reducedByH:core|double,reducedByW:core|double})")))(),
    __ToT: () => (T.__ToT = dart.constFn(dart_rti.findType("0^({desktop:0^?,mobile:0^?,tablet:0^?,watch:0^?})<core|Object?>")))(),
  ...
  dart.addRtiResources(platform_web.GeneralPlatform, ["get__get_utils__src__platform__platform_web|GeneralPlatform"]);
  ...
  dart.addRtiResources(platform.GetPlatform, ["get__get_utils__src__platform__platform|GetPlatform"]);
  ...
  context_extensions['ContextExtensionss|get#responsiveValue'] = function ContextExtensionss$124get$35responsiveValue($this) {
    ...
    }, T.__ToT(), dart.constList([T.dynamic()], T.dynamic()));
  };
