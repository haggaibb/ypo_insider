...
define(['dart_sdk', 'packages/flutter/src/foundation/_timeline_web.dart'], (function load__packages__flutter__src__foundation__timeline_dart(dart_sdk, packages__flutter__src__foundation___timeline_web$46dart) {
  ...
  var T = {
    ...
    VoidToStateError: () => (T.VoidToStateError = dart.constFn(dart_rti.findType("core|StateError()")))(),
    String__Tovoid: () => (T.String__Tovoid = dart.constFn(dart_rti.findType("~(core|String{arguments:core|Map<core|String,core|Object?>?,flow:developer|Flow?})")))(),
    VoidTovoid: () => (T.VoidTovoid = dart.constFn(dart_rti.findType("~()")))(),
    String__Tovoid$1: () => (T.String__Tovoid$1 = dart.constFn(dart_rti.findType("~(core|String{arguments:core|Map<core|String,core|Object?>?})")))(),
    StringAndFn__ToT: () => (T.StringAndFn__ToT = dart.constFn(dart_rti.findType("0^(core|String,0^(){arguments:core|Map<core|String,core|Object?>?,flow:developer|Flow?})<core|Object?>")))(),
    int: () => (T.int = dart.constFn(dart_rti.findType("core|int")))(),
    VoidToAggregatedTimings: () => (T.VoidToAggregatedTimings = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|AggregatedTimings()")))(),
    _BlockBuffer: () => (T._BlockBuffer = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|_BlockBuffer")))(),
    double: () => (T.double = dart.constFn(dart_rti.findType("core|double")))(),
    String: () => (T.String = dart.constFn(dart_rti.findType("core|String")))(),
    RecOfdoubleAndint: () => (T.RecOfdoubleAndint = dart.constFn(dart_rti.findType("+(core|double,core|int)")))(),
    VoidToRec: () => (T.VoidToRec = dart.constFn(dart_rti.findType("+(core|double,core|int)()")))(),
    AggregatedTimedBlock: () => (T.AggregatedTimedBlock = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|AggregatedTimedBlock")))(),
    MapEntryOfString$RecOfdoubleAndintToAggregatedTimedBlock: () => (T.MapEntryOfString$RecOfdoubleAndintToAggregatedTimedBlock = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|AggregatedTimedBlock(core|MapEntry<core|String,+(core|double,core|int)>)")))(),
    AggregatedTimedBlockTobool: () => (T.AggregatedTimedBlockTobool = dart.constFn(dart_rti.findType("core|bool(flutter__src__foundation__timeline|AggregatedTimedBlock)")))(),
    VoidToAggregatedTimedBlock: () => (T.VoidToAggregatedTimedBlock = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|AggregatedTimedBlock()")))(),
    ListOfAggregatedTimedBlock: () => (T.ListOfAggregatedTimedBlock = dart.constFn(dart_rti.findType("core|List<flutter__src__foundation__timeline|AggregatedTimedBlock>")))(),
    VoidToListOfAggregatedTimedBlock: () => (T.VoidToListOfAggregatedTimedBlock = dart.constFn(dart_rti.findType("core|List<flutter__src__foundation__timeline|AggregatedTimedBlock>()")))(),
    StringToAggregatedTimedBlock: () => (T.StringToAggregatedTimedBlock = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|AggregatedTimedBlock(core|String)")))(),
    ListOfTimedBlock: () => (T.ListOfTimedBlock = dart.constFn(dart_rti.findType("core|List<flutter__src__foundation__timeline|TimedBlock>")))(),
    ListNOfAggregatedTimedBlock: () => (T.ListNOfAggregatedTimedBlock = dart.constFn(dart_rti.findType("core|List<flutter__src__foundation__timeline|AggregatedTimedBlock>?")))(),
    Float64List: () => (T.Float64List = dart.constFn(dart_rti.findType("typed_data|Float64List")))(),
    IterableOfdoubleTovoid: () => (T.IterableOfdoubleTovoid = dart.constFn(dart_rti.findType("~(core|Iterable<core|double>)")))(),
    ...
    ListOfFloat64List: () => (T.ListOfFloat64List = dart.constFn(dart_rti.findType("core|List<typed_data|Float64List>")))(),
    ListOfStringN: () => (T.ListOfStringN = dart.constFn(dart_rti.findType("core|List<core|String?>")))(),
    ...
    ListOfListOfStringN: () => (T.ListOfListOfStringN = dart.constFn(dart_rti.findType("core|List<core|List<core|String?>>")))(),
    intToString: () => (T.intToString = dart.constFn(dart_rti.findType("core|String(core|int)")))(),
    TimedBlock: () => (T.TimedBlock = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|TimedBlock")))(),
    VoidToListOfTimedBlock: () => (T.VoidToListOfTimedBlock = dart.constFn(dart_rti.findType("core|List<flutter__src__foundation__timeline|TimedBlock>()")))(),
    _Float64ListChain: () => (T._Float64ListChain = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|_Float64ListChain")))(),
    _StringListChain: () => (T._StringListChain = dart.constFn(dart_rti.findType("flutter__src__foundation__timeline|_StringListChain")))()
  };
  var G = {
    IdentityMapOfString$RecOfdoubleAndint: () => (G.IdentityMapOfString$RecOfdoubleAndint = dart.constFn(_js_helper.IdentityMap$(T.String(), T.RecOfdoubleAndint())))(),
    JSArrayOfFloat64List: () => (G.JSArrayOfFloat64List = dart.constFn(_interceptors.JSArray$(T.Float64List())))(),
    JSArrayOfdouble: () => (G.JSArrayOfdouble = dart.constFn(_interceptors.JSArray$(T.double())))(),
    JSArrayOfListOfStringN: () => (G.JSArrayOfListOfStringN = dart.constFn(_interceptors.JSArray$(T.ListOfStringN())))(),
    ...
    JSArrayOfTimedBlock: () => (G.JSArrayOfTimedBlock = dart.constFn(_interceptors.JSArray$(T.TimedBlock())))()
  };
  ...
  var I = [
    ...
    "dart:core",
    "file:///Users/haggaibarel/DEV/flutter/packages/flutter/lib/src/foundation/timeline.dart",
    "dart:typed_data"
  ];
  ...
  (timeline.TimedBlock.new = function(opts) {
    ...
    this[start$] = start;
    this[end$] = end;
    if (!(end >= start)) dart.assertFailed("The start timestamp must not be greater than the end timestamp.", I[2], 163, 15, "end >= start");
    ;
  ...
  dart.setGetterSignature(timeline.TimedBlock, () => dart.global.Object.setPrototypeOf({duration: T.double()}, dart.getGetters(dart.global.Object.getPrototypeOf(timeline.TimedBlock))));
  ...
  timeline.AggregatedTimings = class AggregatedTimings extends core.Object {
    ...
    [_computeAggregatedBlocks]() {
      let aggregate = new (G.IdentityMapOfString$RecOfdoubleAndint()).new();
      ...
      return aggregate[$entries][$map](T.AggregatedTimedBlock(), dart.fn(entry => new timeline.AggregatedTimedBlock.new({name: entry.key, duration: entry.value.$1, count: entry.value.$2}), T.MapEntryOfString$RecOfdoubleAndintToAggregatedTimedBlock()))[$toList]();
    }
    getAggregated(name) {
  ...
  dart.setMethodSignature(timeline.AggregatedTimings, () => dart.global.Object.setPrototypeOf({
    [_computeAggregatedBlocks]: T.VoidToListOfAggregatedTimedBlock(),
    getAggregated: T.StringToAggregatedTimedBlock()
  }, dart.getMethods(dart.global.Object.getPrototypeOf(timeline.AggregatedTimings))));
  dart.setGetterSignature(timeline.AggregatedTimings, () => dart.global.Object.setPrototypeOf({aggregatedBlocks: T.ListOfAggregatedTimedBlock()}, dart.getGetters(dart.global.Object.getPrototypeOf(timeline.AggregatedTimings))));
  ...
  dart.setFieldSignature(timeline.AggregatedTimings, () => dart.global.Object.setPrototypeOf({
    timedBlocks: {type: T.ListOfTimedBlock(), isConst: false, isFinal: true, libraryUri: I[1]},
    [__AggregatedTimings_aggregatedBlocks]: {type: T.ListNOfAggregatedTimedBlock(), isConst: false, isFinal: false, libraryUri: I[1]}
  ...
  (timeline.AggregatedTimedBlock.new = function(opts) {
    ...
    this[count$] = count;
    if (!(duration >= 0)) dart.assertFailed(null, I[2], 247, 15, "duration >= 0");
    ;
  ...
  timeline._Float64ListChain = class _Float64ListChain extends core.Object {
    ...
    extractElements() {
      let result = G.JSArrayOfdouble().of([]);
      this[_chain][$forEach](T.IterableOfdoubleTovoid()[_as](dart.bind(result, $addAll)));
  ...
  (timeline._Float64ListChain.new = function() {
    this[_chain] = G.JSArrayOfFloat64List().of([]);
    this[_slice] = _native_typed_data.NativeFloat64List.new(500);
    this[_pointer] = 0;
    this[_length] = 0;
    ;
  ...
  dart.setMethodSignature(timeline._Float64ListChain, () => dart.global.Object.setPrototypeOf({
    add: T.doubleTovoid(),
    extractElements: T.VoidToListOfdouble()
  }, dart.getMethods(dart.global.Object.getPrototypeOf(timeline._Float64ListChain))));
  dart.setGetterSignature(timeline._Float64ListChain, () => dart.global.Object.setPrototypeOf({length: T.int()}, dart.getGetters(dart.global.Object.getPrototypeOf(timeline._Float64ListChain))));
  ...
  dart.setFieldSignature(timeline._Float64ListChain, () => dart.global.Object.setPrototypeOf({
    [_chain]: {type: T.ListOfFloat64List(), isConst: false, isFinal: true, libraryUri: I[1]},
    [_slice]: {type: T.Float64List(), isConst: false, isFinal: false, libraryUri: I[3]},
    [_pointer]: {type: T.int(), isConst: false, isFinal: false, libraryUri: I[1]},
  ...
  timeline._StringListChain = class _StringListChain extends core.Object {
    ...
    add(element) {
      ...
      if (this[_pointer] >= 500) {
        this[_chain][$add](this[_slice]);
        this[_slice] = G.ListOfStringN().filled(500, null);
        this[_pointer] = 0;
      }
    }
    extractElements() {
  ...
  (timeline._StringListChain.new = function() {
    this[_chain] = G.JSArrayOfListOfStringN().of([]);
    this[_slice] = G.ListOfStringN().filled(500, null);
    this[_pointer] = 0;
    this[_length] = 0;
    ;
  ...
  dart.setMethodSignature(timeline._StringListChain, () => dart.global.Object.setPrototypeOf({
    add: T.StringTovoid(),
    extractElements: T.VoidToListOfString()
  }, dart.getMethods(dart.global.Object.getPrototypeOf(timeline._StringListChain))));
  dart.setGetterSignature(timeline._StringListChain, () => dart.global.Object.setPrototypeOf({length: T.int()}, dart.getGetters(dart.global.Object.getPrototypeOf(timeline._StringListChain))));
  ...
  dart.setFieldSignature(timeline._StringListChain, () => dart.global.Object.setPrototypeOf({
    [_chain]: {type: T.ListOfListOfStringN(), isConst: false, isFinal: true, libraryUri: I[1]},
    [_slice]: {type: T.ListOfStringN(), isConst: false, isFinal: false, libraryUri: I[1]},
    [_pointer]: {type: T.int(), isConst: false, isFinal: false, libraryUri: I[1]},
    [_length]: {type: T.int(), isConst: false, isFinal: false, libraryUri: I[1]}
  ...
  timeline._BlockBuffer = class _BlockBuffer extends core.Object {
    computeTimings() {
      ...
      if (!(starts[$length] === length)) dart.assertFailed(null, I[2], 394, 12, "starts.length == length");
      if (!(finishes[$length] === length)) dart.assertFailed(null, I[2], 395, 12, "finishes.length == length");
      if (!(names[$length] === length)) dart.assertFailed(null, I[2], 396, 12, "names.length == length");
    ...
    finishSync() {
      if (!(timeline._BlockBuffer._stackPointer > 0)) dart.assertFailed("Invalid sequence of `startSync` and `finishSync`.\nAttempted to finish timing a block of code, but there are no pending `startSync` calls.", I[2], 417, 7, "_stackPointer > 0");
  ...
  dart.setMethodSignature(timeline._BlockBuffer, () => dart.global.Object.setPrototypeOf({
    computeTimings: T.VoidToListOfTimedBlock(),
    startSync: T.String__Tovoid(),
    finishSync: T.VoidTovoid()
  ...
  dart.setFieldSignature(timeline._BlockBuffer, () => dart.global.Object.setPrototypeOf({
    [_starts]: {type: T._Float64ListChain(), isConst: false, isFinal: true, libraryUri: I[0]},
    [_finishes]: {type: T._Float64ListChain(), isConst: false, isFinal: true, libraryUri: I[0]},
    [_names]: {type: T._StringListChain(), isConst: false, isFinal: true, libraryUri: I[0]}
  ...
  dart.defineLazy(timeline._BlockBuffer, {
    ...
    /*timeline._BlockBuffer._nameStack*/get _nameStack() {
      return G.ListOfStringN().filled(1000, null);
    },
  ...
  dart_rti._Universe.addRules(dart.typeUniverse, JSON.parse('{"core|StateError":{"core|Error":[]},"core|String":{"Comparable.T":"core|String","core|Comparable":["core|String"],"core|Pattern":[]},"core|Comparable":{"Comparable.T":"1"},"core|Map":{"Map.K":"1","Map.V":"2"},"core|int":{"core|num":[],"Comparable.T":"core|num","core|Comparable":["core|num"]},"core|num":{"Comparable.T":"core|num","core|Comparable":["core|num"]},"core|double":{"core|num":[],"Comparable.T":"core|num","core|Comparable":["core|num"]},"core|MapEntry":{"MapEntry.K":"1","MapEntry.V":"2"},"core|List":{"List.E":"1","Iterable.E":"1","core|Iterable":["1"],"_ListIterable.E":"1","core|_ListIterable":["1"],"EfficientLengthIterable.T":"1","_internal|EfficientLengthIterable":["1"],"HideEfficientLengthIterable.T":"1","_internal|HideEfficientLengthIterable":["1"]},"core|Iterable":{"Iterable.E":"1"},"core|_ListIterable":{"_ListIterable.E":"1","EfficientLengthIterable.T":"1","_internal|EfficientLengthIterable":["1"],"HideEfficientLengthIterable.T":"1","_internal|HideEfficientLengthIterable":["1"],"Iterable.E":"1","core|Iterable":["1"]},"_internal|EfficientLengthIterable":{"EfficientLengthIterable.T":"1","Iterable.E":"1","core|Iterable":["1"]},"_internal|HideEfficientLengthIterable":{"HideEfficientLengthIterable.T":"1","Iterable.E":"1","core|Iterable":["1"]},"typed_data|Float64List":{"List.E":"core|double","core|List":["core|double"],"typed_data|_TypedFloatList":[],"Iterable.E":"core|double","core|Iterable":["core|double"],"_ListIterable.E":"core|double","core|_ListIterable":["core|double"],"typed_data|TypedData":[],"EfficientLengthIterable.T":"core|double","_internal|EfficientLengthIterable":["core|double"],"HideEfficientLengthIterable.T":"core|double","_internal|HideEfficientLengthIterable":["core|double"]},"typed_data|_TypedFloatList":{"typed_data|TypedData":[]}}'));
  dart.trackLibraries("packages/flutter/src/foundation/timeline.dart", {
    "package:flutter/src/foundation/timeline.dart": timeline
  }, {
  }, '{"version":3,"sourceRoot":"","sources":