                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: TextField(
                                ...
                                onChanged: (s) =>
                                    {if (GetUtils.isPhoneNumber(s)) {} else {}},
                              ),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: DropdownMenu(
                                ...
                                initialSelection:
                                    mainController.residenceList[0],
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            const Text('Member Since (i.e. 2025):',
                                style: TextStyle(fontWeight: FontWeight.bold)),
                            Padding(
                              padding: const EdgeInsets.only(left: 12.0),
                              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addMode
                        ...
                        : DropdownMenu(
                            leadingIcon: Icon(
                                color: Colors.blue.shade900, Icons.text_fields),
                            ...
                            dropdownMenuEntries: mainController.freeTextTagsList
                                .map((tag) => tag['label'] as String)
                                .toList()
                                .map<DropdownMenuEntry<String>>((String tag) {
                              return DropdownMenuEntry<String>(
                                value: tag,
                                label: tag,
                                style: MenuItemButton.styleFrom(
                            ...
                            onSelected: (label) {
                              ...
                              int index = mainController.freeTextTagsList
                                  .indexWhere((tag) => tag['label'] == label);
                              if (index != -1) {
                                var tag =
                            ...
                            onPressed: () async {
                              ...
                              bool? res = await showDialog<bool>(
                                  ...
                                  builder: (BuildContext context) =>
                                      ConfirmDialog(tag: (labelCtrl.text)));
                              if (res ?? false) {
                                setState(() {
                                  mainController.saving.value = true;
                                });
                                await mainController.removeFreeTextTag(
                                    labelCtrl.text, templateId);
                                setState(() {
                                  /// remove local
                                  mainController.saving.value = false;
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    newMemberScoreCtrl.text =
        mainController.profileScore.newMemberScore.toString();
    birthdayScoreCtrl.text =
        mainController.profileScore.birthdayScore.toString();
    socialScoreCtrl.text = mainController.profileScore.socialScore.toString();
    profileImageScoreCtrl.text =
        mainController.profileScore.profileImageScore.toString();
    topThresholdCtrl.text = mainController.profileScore.topThreshold.toString();
    bottomThresholdCtrl.text =
        mainController.profileScore.bottomThreshold.toString();
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                        ...
                                        height: 50,
                                        child: TextField(
                                          enabled: profileScoreEditModeOn
                                              ? true
                                              : false,
                                        ...
                                        ElevatedButton(
                                            onPressed: () async {
                                              ...
                                              await mainController.updateProfileScoreSettings(
                                                  birthdayScore: int.parse(
                                                      birthdayScoreCtrl.text),
                                                  profileImageScore: int.parse(
                                                      profileImageScoreCtrl
                                                          .text),
                                                  newMemberScore: int.parse(
                                                      newMemberScoreCtrl.text),
                                                  socialScore: int.parse(
                                                      socialScoreCtrl.text),
                                                  topThreshold: int.parse(
                                                      topThresholdCtrl.text),
                                                  bottomThreshold: int.parse(
                                                      bottomThresholdCtrl
                                                          .text));
                                              const snackBar = SnackBar(
                                                content: Text(
                                      ...
                                      children: [
                                        ElevatedButton(
                                            onPressed: () async {
                                              ...
                                              await mainController
                                                  .updateResultsPageSettings(
                                                      newMemberThresholdInMonths:
                                                          newMemberThresholdInMonthsCtrl
                                                              .text,
                                                      numberOfRandomMembers:
                                                          numberOfRandomResultsCtrl
                                                              .text);
                                              setState(() {
                                                mainController.saving.value =
                                                    false;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                        ...
                                        height: 50,
                                        child: TextField(
                                          enabled: maxFileSizeEditModeOn
                                              ? true
                                              : false,
                                          controller:
                                              profilePictureMaxSizeInMBCtrl,
                                        )),
                                  )
                                ],
                              ),
                            ...
                            children: List.generate(
                                ...
                                (index) => Padding(
                                      padding: const EdgeInsets.only(
                                          ...
                                          bottom: 10),
                                      child: SizedBox(
                                        child: (mainController.filteredTagsList[
                                                        index]['key'] !=
                                                    'residence' &&
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (res !=
                                                                        ...
                                                                        setState(
                                                                            () {
                                                                          mainController
                                                                              .filteredTagsList[index]['tags_list']
                                                                              .add(res);
                                                                          mainController
                                                                              .saving
                                                                              .value = false;
                                                          ...
                                                          IconButton(
                                                              onPressed:
                                                                ...
                                                                if (res ??
                                                                  ...
                                                                  await mainController.removeFilterTagCategory(
                                                                      mainController
                                                                ...
                                                                ChoiceChip(
                                                                    onSelected:
                                                                      ...
                                                                      if (editMode) {
                                                                        ...
                                                                        if (res !=
                                                                            null) {
                                                                          await mainController.updateFilterTag(
                                                                              mainController.filteredTagsList[index]['label'],
                                                                        ...
                                                                        if (res ??
                                                                          ...
                                                                          await mainController.removeFilterTag(
                                                                              mainController.filteredTagsList[index]['label'],
                                                                              mainController.filteredTagsList[index]['tags_list'][tagIndex]);
                                                                          setState(
                                                                              () {
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (res != null) {
                                ...
                                await mainController.addNewFilterTagCategory(
                                    res, '');
                                _scrollToEnd();
                                setState(() {
                                  mainController.saving.value = false;
...
class AddNewFilterCategoryDialog extends StatelessWidget {
  const AddNewFilterCategoryDialog({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        TextButton(
          onPressed: () =>
              Navigator.pop(context, newFilterTagCategoryCtrl.text),
          child: const Text('Save'),
        ),
        TextButton(
          onPressed: () => Navigator.pop(context, null),
...
class ConfirmDialog extends StatelessWidget {
  final String tag;
  const ConfirmDialog({required this.tag, super.key});
      ...
      content: SizedBox(
        ...
        child: Column(
          children: [
            ...
            const Text(
                'This will permanently remove this tag from all members!')
          ],
        ),
      ),
      actions: <Widget>[
